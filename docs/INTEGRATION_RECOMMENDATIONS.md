...
| options.categories | array of category path strings | all | optional category identifier for category trending rec type |
| options.brands | array of brand strings | all | optional brand identifier for category trending rec type |
