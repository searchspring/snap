...
### Middleware
Autocomplete supports middleware to hook into various events using `use` and `on` methods. See [Search Middlewear](http://searchspring.github.io/snap/docs/#/search) for usage
