import { pluginShopifyAddToCart as pluginAddToCart } from './pluginShopifyAddToCart';
...
describe('shopify/addToCart', () => {
	...
	it('assigns a function to get called when addToCart function is used on the controller', async () => {
		...
		expect(controller.eventManager.events.addToCart.functions[0].name).toBe('addToCartShopifyEvent');
