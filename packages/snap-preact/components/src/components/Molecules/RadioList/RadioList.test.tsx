...
describe('RadioList Component', () => {
	...
	it('it can hideLabels', async () => {
		...
		expect(optionElements.innerHTML).toBe(
			`<span class=\"ss__radio ss__radio-list__option__radio ss-1n8vnmv\" aria-label=\" unchecked radio button\" role=\"radio\" aria-checked=\"false\"><svg ss-name=\"inactive\" class=\"ss__icon ss__icon--bullet-o ss__radio__icon--inactive ss-rbptfi\" viewBox=\"0 0 56 56\" xmlns=\"http://www.w3.org/2000/svg\" name=\"inactive\"><circle cx=\"28\" cy=\"28\" r=\"20\" stroke-width=\"3\" fill=\"white\"></circle></svg></span>`
		);
