...
///note this test file uses controllers and stores, which are not yet typed. So it needs to be commented out till they are.
describe('Snap Client Integration Tests', () => {
	...
	// 	it('Cache can be disabled via the config', async () => {
	// 		const clientConfig = {
	// 			search: {
	// 				cache: {
	// 					enabled: false,
