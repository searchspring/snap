...
Utilizes `formatNumber` from <a target="_blank" rel="noopener noreferrer" href="https://searchspring.github.io/snap/reference-toolbox-filters">@searchspring/snap-toolbox</a> to render a `<span>` containing a formatted number.
