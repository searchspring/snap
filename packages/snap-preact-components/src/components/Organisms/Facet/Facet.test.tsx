...
describe('Facet Component', () => {
	...
	describe('List Facet Display', () => {
		it('renders', () => {
			...
			const count = facetElement.querySelectorAll('.ss-list__link').length;
	...
	describe('Grid Facet Display', () => {
		it('renders', () => {
			...
			const facetElement = rendered.container.querySelector('.ss-facet-options');
			expect(facetElement).toBeInTheDocument();
			const count = facetElement.querySelectorAll('.ss-grid-optionWrapper').length;
			expect(count).toEqual(args.facet['values'].length);
		});
	});
	...
	describe('Palette Facet Display', () => {
		it('renders', () => {
			...
			const facetElement = rendered.container.querySelector('.ss-facet-options');
			expect(facetElement).toBeInTheDocument();
			const count = facetElement.querySelectorAll('.ss-palette-option').length;
			expect(count).toEqual(args.facet['values'].length);
		});
	});
