(window.webpackJsonp = window.webpackJsonp || []).push([
	[5],
	{
		1038: function (module, exports, __webpack_require__) {
			const cssKeywords = __webpack_require__(1095),
				reverseKeywords = {};
		...
		1094: function (module, exports, __webpack_require__) {
			const conversions = __webpack_require__(1038),
				route = __webpack_require__(1096),
				convert = {};
		...
		1097: function (module, exports, __webpack_require__) {
			var debounce = __webpack_require__(1098),
		...
		1098: function (module, exports, __webpack_require__) {
			var isObject = __webpack_require__(124),
				now = __webpack_require__(1099),
				toNumber = __webpack_require__(1100),
				nativeMax = Math.max,
				nativeMin = Math.min;
		...
		1100: function (module, exports, __webpack_require__) {
			var baseTrim = __webpack_require__(1101),
				isObject = __webpack_require__(124),
		...
		1101: function (module, exports, __webpack_require__) {
			var trimmedEndIndex = __webpack_require__(1102),
				reTrimStart = /^\s+/;
		...
		523: function (module, __webpack_exports__, __webpack_require__) {
			...
			var Note = __webpack_require__(4).styled.div(function (_ref) {
				...
				TooltipNote = function TooltipNote(_ref2) {
					...
					return react__WEBPACK_IMPORTED_MODULE_3__.default.createElement(Note, props, note);
				};
		...
		999: function (module, __webpack_exports__, __webpack_require__) {
			...
			var index_module_c = 'undefined' != typeof window ? compat_module.useLayoutEffect : compat_module.useEffect;
			function index_module_i(e) {
				var r = Object(compat_module.useRef)(e);
				return (
					Object(compat_module.useEffect)(function () {
						r.current = e;
					}),
					Object(compat_module.useCallback)(function (e) {
			...
			var index_module_s,
				...
				index_module_h = compat_module.default.memo(function (r) {
					var t = r.onMove,
						s = r.onKey,
						f = index_module_u(r, ['onMove', 'onKey']),
						h = Object(compat_module.useRef)(null),
						m = Object(compat_module.useRef)(!1),
						g = Object(compat_module.useState)(!1),
						p = g[0],
						b = g[1],
						_ = index_module_i(t),
						C = index_module_i(s),
						E = Object(compat_module.useCallback)(
							function (e) {
								e.preventDefault(), (index_module_v(e) ? e.touches.length > 0 : e.buttons > 0) && h.current ? _(index_module_d(h.current, e)) : b(!1);
							},
							[_]
						),
						x = Object(compat_module.useCallback)(
							function (e) {
								var r = e.nativeEvent;
								r.preventDefault(),
									(function (e) {
						...
						H = Object(compat_module.useCallback)(
							function (e) {
								var r = e.which || e.keyCode;
								r < 37 ||
									r > 40 ||
									(e.preventDefault(), C({ left: 39 === r ? 0.05 : 37 === r ? -0.05 : 0, top: 40 === r ? 0.05 : 38 === r ? -0.05 : 0 }));
							},
							[C]
						),
						N = Object(compat_module.useCallback)(function () {
							return b(!1);
						}, []),
						w = Object(compat_module.useCallback)(
							function (e) {
				...
				index_module_ = function (e) {
					...
					return r
						? index_module_E({ h: Number(r[1]), s: Number(r[2]), l: Number(r[3]), a: void 0 === r[4] ? 1 : Number(r[4]) })
						: { h: 0, s: 0, v: 0, a: 1 };
				},
				...
				q = function (e) {
					...
					return r ? I({ r: Number(r[1]), g: Number(r[2]), b: Number(r[3]), a: void 0 === r[4] ? 1 : Number(r[4]) }) : { h: 0, s: 0, v: 0, a: 1 };
				},
				O = function (e) {
					var r = e.toString(16);
				...
				I = function (e) {
					...
					return { h: index_module_p(60 * (u < 0 ? u + 6 : u)), s: index_module_p(a ? (l / a) * 100 : 0), v: index_module_p((a / 255) * 100), a: n };
				},
				z = compat_module.default.memo(function (r) {
					var t = r.hue,
						o = r.onChange,
					...
					return compat_module.default.createElement(
						...
						compat_module.default.createElement(
							...
							compat_module.default.createElement(index_module_g, {
				...
				B = compat_module.default.memo(function (r) {
					var t = r.hsva,
						o = r.onChange,
			...
			function D(e, r, l) {
				var u = index_module_i(l),
					c = Object(compat_module.useState)(function () {
						return e.toHsva(r);
					}),
					s = c[0],
					f = c[1],
					v = Object(compat_module.useRef)({ color: r, hsva: s });
				Object(compat_module.useEffect)(
					function () {
					...
					Object(compat_module.useEffect)(
						function () {
							var r;
							K(s, v.current.hsva) || e.equal((r = e.fromHsva(s)), v.current.color) || ((v.current = { hsva: s, color: r }), u(r));
						},
						[s, e, u]
					);
				var d = Object(compat_module.useCallback)(function (e) {
					f(function (r) {
			...
			var L,
				...
				X = function (r) {
					...
					return compat_module.default.createElement(
						...
						compat_module.default.createElement(B, { hsva: f, onChange: v }),
						compat_module.default.createElement(z, { hue: f.h, onChange: v, className: 'react-colorful__last-control' })
					);
				},
				Y = {
					defaultColor: '000',
				...
				P = function (r) {
					...
					return compat_module.default.createElement(
						...
						compat_module.default.createElement(
							...
							compat_module.default.createElement(index_module_g, { className: 'react-colorful__alpha-pointer', left: o.a, color: index_module_N(o) })
						)
					);
				},
				R = function (r) {
					...
					return compat_module.default.createElement(
						...
						index_module_l({}, i, { className: d }),
						compat_module.default.createElement(B, { hsva: f, onChange: v }),
						compat_module.default.createElement(z, { hue: f.h, onChange: v }),
						compat_module.default.createElement(P, { hsva: f, onChange: v, className: 'react-colorful__last-control' })
					);
				},
			...
			var Wrapper = esm.styled.div({ position: 'relative', maxWidth: 250 }),
				...
				Color_Swatch = function Swatch(_ref3) {
					...
					return compat_module.default.createElement(
						SwatchColor,
						_extends({}, props, { active: active, onClick: onClick, style: Object.assign({}, style, { backgroundImage: backgroundImage }) })
					);
				};
			...
			var COLOR_SPACES = Object.values(ColorSpace),
				...
				ColorPicker =
					(_defineProperty((_ColorPicker = {}), ColorSpace.HEX, function (r) {
						return compat_module.default.createElement(X, index_module_l({}, r, { colorModel: Y }));
					}),
					_defineProperty(_ColorPicker, ColorSpace.RGB, function (r) {
						return compat_module.default.createElement(R, index_module_l({}, r, { colorModel: fe }));
					}),
					_defineProperty(_ColorPicker, ColorSpace.HSL, function (r) {
						return compat_module.default.createElement(R, index_module_l({}, r, { colorModel: Q }));
					}),
					_ColorPicker),
				fallbackColor =
				...
				Color_parseValue = function parseValue(value) {
					...
					if (value) {
						...
						if (RGB_REGEXP.test(value)) {
							...
							return (
								_defineProperty(
									(_ref8 = { valid: valid, value: value, keyword: color_convert_default.a.rgb.keyword([r, g, b]), colorSpace: ColorSpace.RGB }),
									ColorSpace.RGB,
									value
								),
								_defineProperty(_ref8, ColorSpace.HSL, 'hsla('.concat(h, ', ').concat(s, '%, ').concat(l, '%, ').concat(a, ')')),
								_defineProperty(_ref8, ColorSpace.HEX, '#'.concat(color_convert_default.a.rgb.hex([r, g, b]).toLowerCase())),
								_ref8
							);
						}
						if (HSL_REGEXP.test(value)) {
							...
							return (
								_defineProperty(
									(_ref11 = { valid: valid, value: value, keyword: color_convert_default.a.hsl.keyword([_h, _s2, _l]), colorSpace: ColorSpace.HSL }),
									ColorSpace.RGB,
									'rgba('.concat(_r, ', ').concat(_g, ', ').concat(_b, ', ').concat(_a, ')')
								),
								_defineProperty(_ref11, ColorSpace.HSL, value),
								_defineProperty(_ref11, ColorSpace.HEX, '#'.concat(color_convert_default.a.hsl.hex([_h, _s2, _l]).toLowerCase())),
								_ref11
							);
						}
						...
						return (
							_defineProperty(
								(_ref12 = { valid: valid, value: mapped, keyword: color_convert_default.a.rgb.keyword(rgb), colorSpace: ColorSpace.HEX }),
								ColorSpace.RGB,
								'rgba('.concat(rgb[0], ', ').concat(rgb[1], ', ').concat(rgb[2], ', 1)')
							),
							_defineProperty(_ref12, ColorSpace.HSL, 'hsla('.concat(hsl[0], ', ').concat(hsl[1], '%, ').concat(hsl[2], '%, 1)')),
				...
				Color_useColorInput = function useColorInput(initialValue, onChange) {
					var _useState2 = _slicedToArray(Object(compat_module.useState)(initialValue || ''), 2),
						value = _useState2[0],
						setValue = _useState2[1],
						_useState4 = _slicedToArray(
							Object(compat_module.useState)(function () {
						...
						_useState6 = _slicedToArray(Object(compat_module.useState)((null == color ? void 0 : color.colorSpace) || ColorSpace.HEX), 2),
						colorSpace = _useState6[0],
						setColorSpace = _useState6[1],
						realValue = Object(compat_module.useMemo)(
							function () {
						...
						updateValue = Object(compat_module.useCallback)(
							function (update) {
						...
						cycleColorSpace = Object(compat_module.useCallback)(
							function () {
				...
				Color_ColorControl = function ColorControl(_ref13) {
					var initialValue = _ref13.value,
						...
						_usePresets = (function usePresets(presetColors, currentColor, colorSpace) {
							var _useState8 = _slicedToArray(Object(compat_module.useState)(null != currentColor && currentColor.valid ? [currentColor] : []), 2),
								selectedColors = _useState8[0],
								setSelectedColors = _useState8[1],
								presets = Object(compat_module.useMemo)(
									function () {
										return (presetColors || [])
											.map(function (preset) {
								...
								addPreset = Object(compat_module.useCallback)(
									function (color) {
										null != color &&
											color.valid &&
					...
					return compat_module.default.createElement(
						...
						compat_module.default.createElement(
											...
											presets.map(function (preset) {
												return compat_module.default.createElement(
													lazy_WithTooltip.a,
													{
														key: preset.value,
														hasChrome: !1,
														tooltip: compat_module.default.createElement(Note, { note: preset.keyword || preset.value }),
													},
													compat_module.default.createElement(Color_Swatch, {
							...
							compat_module.default.createElement(Color_Swatch, { value: realValue, style: { margin: 4 } })
						),
						...
						compat_module.default.createElement(ToggleIcon, { icon: 'markup', onClick: cycleColorSpace })
					);
				};
