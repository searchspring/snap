/*! For license information please see 6.f540625d299f941c89c1.manager.bundle.js.LICENSE.txt */
	...
	[6],
	{
		850: function (module, __webpack_exports__, __webpack_require__) {
			...
			var react__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(0),
				...
				overlayscrollbars__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(874),
			...
			var OverlayScrollbarsComponent = function OverlayScrollbarsComponent(_ref) {
				...
				return (
					...
					react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(
						...
						react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement('div', { className: 'os-resize-observer-host' }),
						react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(
							'div',
							...
							react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(
								...
								react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement('div', { className: 'os-content' }, children)
							)
						),
						react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(
							'div',
							...
							react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(
								...
								react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement('div', { className: 'os-scrollbar-handle' })
							)
						),
						react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(
							'div',
						...
						return (function (window, document, undefined) {
							...
							var _targets,
									...
									function startNextAnimationInQ(animObj, removeFromQ) {
										...
										!1 !== removeFromQ && animObj.q.splice(0, 1),
											animObj.q[LEXICON.l] > 0
												? ((nextAnim = animObj.q[0]), animate(animObj.el, nextAnim.props, nextAnim.duration, nextAnim.easing, nextAnim.complete, !0))
														...
														(frame = function () {
															...
															to))
																(fromVal = parseFloat(from[key])),
																	...
																	(easedVal =
																		(toVal - fromVal) * EASING[specialEasing[key] || easing](percent, percent * duration, 0, 1, duration) + fromVal),
												...
												return (
													this.each(function () {
														for (ch = this.children, i = 0; i < ch[LEXICON.l]; i++)
															(el = ch[i]),
																selector ? ((el.matches && el.matches(selector)) || matches(el, selector)) && children.push(el) : children.push(el);
													}),
													FakejQuery(children)
												);
											},
								...
								PLUGIN = (function () {
																		...
																		for (i = 0; i < templateTypes[LEXICON.l]; i++)
																			if (
																				...
																				for (
																					...
																					for (
																						mainPossibility = (restrictedStringValuesPossibilitiesSplit = restrictedStringValuesSplit[v].split(
																							':'
																						))[0],
																							j = 0;
															...
															if ((valueArrLength = value[strLength]) > 2 || valueArrLength < 1) value = resultDefault;
																...
																for (1 === valueArrLength && (value[1] = defaultValue), i = 0; i < valueArrLength; i++)
																	if (
																		...
																		type(valueArrItem) != valueInternalType || !checkSettingsStringValue(valueArrItem, allowedValues))
																	) {
																		value = resultDefault;
																		break;
																	}
															...
															setContentGlueElementCSSfunction = function (horizontal) {
																...
																(!autoSize || (!autoSize && border.c)) && (contentGlueElementCSS[strWH] = hostAbsoluteRectSize[wh] - 1),
																	!(autoSize && contentSize[wh] < viewportSize) ||
																		...
																		(_isTextarea && (textareaCoverCSS[strWH] = parseToZeroOrNumber(_textareaCoverElement.css(strWH)) - 1),
														...
														setOverflowVariables = function (horizontal) {
															...
															(overflowBehaviorIsVS[xy] = 'v-s' === overflowBehavior[xy]),
																...
																(overflowAmount[xy] *=
																	...
																	(checkFractionalOverflowAmount && fractionalOverflowAmount > 0 && fractionalOverflowAmount < 1)
																		? 0
																		: 1),
															...
															(hasOverflow.c ||
																...
																(setContentElementCSS = function (horizontal) {
																	...
																	_nativeScrollbarIsOverlaid[xy] && hasOverflow[xy] && hideOverflow[xy + 's']
																		...
																		: ((arrangeContent[scrollbarVarsInverted._w_h] = contentElementCSS['margin-' + strDirection] = contentElementCSS[
																				'border-' + strDirection
																		  ] = ''),
																		  (arrangeChanged = !0));
																}),
													...
													if (
														...
														(hostSizeChanged ||
															...
															((hasOverflow.x && hideOverflow.x && !_nativeScrollbarIsOverlaid.x) ||
																...
																: (viewportElementCSS['padding-top'] = viewportElementCSS['margin-top'] = viewportElementCSS[
																		'padding-' + isRTLRight
																	...
																	y: (
																		textareaAutoWrapping
																			? cursorIsLastPosition ||
																			  (textareaRowsChanged && previousOverflowAmount && currScroll.y === previousOverflowAmount.y)
										...
										function setupScrollbarEvents(isHorizontal) {
												...
												if (onMouseTouchDownContinue(event)) {
													var trackLength = scrollbarVarsInfo._trackLength,
														...
														scrollDelta =
															...
															(((getPointerPosition(event) - mouseDownOffset) * mouseDownInvertedScale) / (trackLength - handleLength));
											...
											function documentMouseTouchUp(event) {
												if (
													...
													trackTimeout !== undefined && (_base.scrollStop(), clearTimeout(trackTimeout), (trackTimeout = undefined)),
													event)
												) {
									...
									return (
										((_plugin = window.OverlayScrollbars = function (pluginTargetElements, options, extensions) {
											if (0 === arguments[LEXICON.l]) return this;
											var inst,
												result,
												arr = [],
											...
											return pluginTargetElements
												? ((pluginTargetElements =
														pluginTargetElements[LEXICON.l] != undefined ? pluginTargetElements : [pluginTargetElements[0] || pluginTargetElements]),
