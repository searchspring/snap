	...
	[135],
	{
		45135: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
			...
			var s = function (e, r, t) {
				...
				h = compat_module.ZP.memo(function (o) {
					var a = o.onMove,
						l = o.onKey,
						s = c(o, ['onMove', 'onKey']),
						...
						m = i(a),
						g = i(l),
						p = (0, compat_module.sO)(null),
						b = (0, compat_module.sO)(!1),
						_ = (0, compat_module.Ye)(
							function () {
								var e = function (e) {
				...
				Q = function (r) {
					...
					return compat_module.ZP.createElement(
						...
						compat_module.ZP.createElement(
							...
							compat_module.ZP.createElement(g, { className: 'react-colorful__alpha-pointer', left: n.a, color: w(n) })
						)
					);
				},
				U = function (r) {
