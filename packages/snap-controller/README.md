...
```
### Instantiate
SearchController requires a `SearchControllerConfig` object and `ControllerServices` object
...
### Instantiate
AutocompleteController requires a `AutocompleteControllerConfig` object and `ControllerServices` object
