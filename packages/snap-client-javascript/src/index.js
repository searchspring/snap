...
export default class SnapClient {
    ...
    #fetchMeta(params) {
        ...
        meta.promises[this.#global.siteId] = this.#requesters.meta.postMeta(constructedParams).then(data => {
    ...
    async autocomplete(params) {
        ...
        const [ results ] = await Promise.all([
            this.#requesters.autocomplete.postAutocomplete(constructedParams),
            meta.promises[constructedParams.siteId]
        ]);
    ...
    async search(params) {
        ...
        const [ results ] = await Promise.all([
            this.#requesters.search.postSearch(constructedParams),
            meta.promises[constructedParams.siteId]
        ]);
