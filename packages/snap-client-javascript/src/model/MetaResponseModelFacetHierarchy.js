...
class MetaResponseModelFacetHierarchy {
     ...
     */
    constructor() { 
        MetaResponseModelFacet.initialize(this);MetaResponseModelFacetDefaults.initialize(this);MetaResponseModelFacetValue.initialize(this);MetaResponseModelFacetHierarchyAllOf.initialize(this);
